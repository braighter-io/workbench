...
**Architecture:** PR1 of the four-PR "design-system adoption" charter (`docs/superpowers/specs/2026-05-27-design-system-ideas-adoption-design.md`). The charter's #4 ("two-axis tag governance") is *already implemented and enforced* in this repo under the tags `scope:` (lib group) / `type:` (layer) / `platform:` (framework). So PR1 does only the genuinely-new work: delete the React lib (Angular-only decision; React added later if needed, recoverable from git history) and close the one open enforcement gap. No tag renames.
...
gh pr create --fill --base main \
  ...
  --body "PR1 of the design-system adoption charter (docs/superpowers/specs/2026-05-27-design-system-ideas-adoption-design.md).
