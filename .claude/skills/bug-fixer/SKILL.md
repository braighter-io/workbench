...
Read `.claude/sdlc.json` at the project root for project-specific paths (cookbook, test infrastructure, PR template, scopes).
...
Use the project's shared test infrastructure (referenced in `.claude/sdlc.json`):
