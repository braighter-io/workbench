---
name: story-runner
description: "Implement a story end-to-end: plan, code, test, lint, commit, PR. Reads .claude/sdlc.json to decide source: github-issues (issue number) or gap-analysis (story id)."
...
Read `.claude/sdlc.json` at the project root. Recognised fields:
...
If `.claude/sdlc.json` is missing, stop and tell the user to create
