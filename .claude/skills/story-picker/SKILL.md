---
name: story-picker
description: "Find the next story ready to start. Reads .claude/sdlc.json to decide source: github-issues (kanban:ready labelled) or gap-analysis.md BACKLOG rows."
...
Read `.claude/sdlc.json` at the project root. Relevant fields:
